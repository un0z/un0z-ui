...
const FONT_EN = `"Geist","Geist Variable","Segoe UI","SF Pro Display",-apple-system,BlinkMacSystemFont,Roboto,Oxygen,Ubuntu,Cantarell,"Open Sans","Helvetica Neue",sans-serif`;
...
const FONT_CODE = `"Geist Mono","GeistMono Variable",Hack,ui-monospace,SFMono-Regular,SF Mono,Menlo,Consolas`;
