...
```tsx
import { ColorScales, primary } from '@un0z/ui/color';
...
```tsx
import { ColorScales, red } from '@un0z/ui/color';
...
```tsx
import { ColorScales, volcano } from '@un0z/ui/color';
...
```tsx
import { ColorScales, orange } from '@un0z/ui/color';
...
```tsx
import { ColorScales, gold } from '@un0z/ui/color';
...
```tsx
import { ColorScales, yellow } from '@un0z/ui/color';
...
```tsx
import { ColorScales, lime } from '@un0z/ui/color';
...
```tsx
import { ColorScales, green } from '@un0z/ui/color';
...
```tsx
import { ColorScales, cyan } from '@un0z/ui/color';
...
```tsx
import { ColorScales, blue } from '@un0z/ui/color';
...
```tsx
import { ColorScales, geekblue } from '@un0z/ui/color';
...
```tsx
import { ColorScales, purple } from '@un0z/ui/color';
...
```tsx
import { ColorScales, magenta } from '@un0z/ui/color';
...
```tsx
import { ColorScales, gray } from '@un0z/ui/color';
...
```tsx
import { ColorScales, mauve } from '@un0z/ui/color';
...
```tsx
import { ColorScales, olive } from '@un0z/ui/color';
...
```tsx
import { ColorScales, sage } from '@un0z/ui/color';
...
```tsx
import { ColorScales, sand } from '@un0z/ui/color';
...
```tsx
import { ColorScales, slate } from '@un0z/ui/color';
