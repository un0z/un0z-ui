...
const nav: INavItem[] = [
  ...
  { link: '/components/brand/un0z', title: 'Brand' },
...
for (const pkg of packages) alias[`@un0z/ui/${pkg}`] = resolve(__dirname, `./src/${pkg}`);
...
export default defineConfig({
  ...
  favicons: ['https://www.un0z.com/favicon.ico'],
  jsMinifier: 'swc',
