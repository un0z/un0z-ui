import { Center, Highlighter, Snippet } from '@un0z/ui';
import { Features, type FeaturesProps } from '@un0z/ui/awesome';
...
const example = `import { ThemeProvider, Button, I18nProvider } from '@un0z/ui'
import allResources from '@un0z/ui/i18n/resources/all'
  ...
  return (
    ...
    >
      <Center>
        ...
        <Snippet language={'bash'}>{'$ bun add @un0z/ui'}</Snippet>
        <p style={{ color: theme.colorTextSecondary, textAlign: 'center' }}>
          The Un0z UI components are developed based on{' '}
